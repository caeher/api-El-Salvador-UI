...
<template>
  <div class="relative overflow-hidden bg-white dark:bg-black/50 py-12">
    ...
    <div class="relative">
      <div class="prose prose-md prose-slate max-w-3xl dark:bg-[#000005] p-5 md:my-12 lg:p-6 md:rounded-lg mx-auto dark:prose-invert">
        <slot />
      </div>
    </div>
  </div>
